...
from automl.search_algorithm import grid_search
...
def training(models, metric_list, metric_sort, x_train, y_train):
    ...
    for model_id in range(len(models)):
        ...
        model_instant = model_info['model']
        param_grid = model_info['params']

        model_class = type(model_instant)

        current_best_params, current_best_score, all_scores = grid_search(
        ...
        results = {
            "model_id": model_id,
            "model_name": model_instant.__class__.__name__,
        ...
        if current_best_score > best_score:
            ...
            best_model = model_class(**current_best_params)
